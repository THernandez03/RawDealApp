...
<div class="actions" id="divActions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Feriado.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Feriado.id'))); ?></li>
