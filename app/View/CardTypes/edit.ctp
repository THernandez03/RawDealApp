<div class="cardTypes form">
<?php echo $this->Form->create('CardType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Card Type'); ?></legend>
	<?php
...
<div class="actions" id="divActions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CardType.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CardType.id'))); ?></li>
