<div class="cardTypes index">
	<h2><?php echo __('Card Types'); ?></h2>
	...
	<tr>
		<td><?php echo h($cardType['CardType']['id']); ?>&nbsp;</td>
		<td><?php echo h($cardType['CardType']['name']); ?>&nbsp;</td>
		<td><?php echo h($cardType['CardType']['created']); ?>&nbsp;</td>
		<td><?php echo h($cardType['CardType']['description']); ?>&nbsp;</td>
		<td><?php echo h($cardType['CardType']['modified']); ?>&nbsp;</td>
		<td class="actions">
