...
<html>
	<head>
		...
		<?php
		   echo $this->Html->script('jquery-ui.multidatespicker.js');		   
		?>
		...
		<!--
			...
			$j(function() {
				// Version //
				//$j('title').append(' v' + latestMDPver);
				//$j('.mdp-version').text('v' + latestMDPver);
				$j('#mdp-title').attr('title', 'last update: ' + lastMDPupdate);
				
				// Documentation //
				$j('i:contains(type)').attr('title', '[Optional] accepted values are: "allowed" [default]; "disabled".');
				$j('i:contains(format)').attr('title', '[Optional] accepted values are: "string" [default]; "object".');
				$j('#how-to h4').each(function () {
					var a = $j(this).closest('li').attr('id');
					$j(this).wrap('<'+'a href="#'+a+'"></'+'a>');
				});
				$j('#demos .demo').each(function () {
					var id = $j(this).find('.box').attr('id') + '-demo';
					$j(this).attr('id', id)
						.find('h3').wrapInner('<'+'a href="#'+id+'"></'+'a>');
				});
				
				// Run Demos
				$j('.demo .code').each(function() {
					eval($j(this).attr('title','NEW: edit this code and test it!').text());
					this.contentEditable = true;
				}).focus(function() {
					if(!$j(this).next().hasClass('test'))
						$j(this)
							.after('<button class="test">test</button>')
							.next('.test').click(function() {
								$j(this).closest('.demo').find('.hasDatepicker').multiDatesPicker('destroy');
								eval($j(this).prev().text());
								$j(this).remove();
							});
				});
			});
		...
		<?php
		    echo $this->Html->css('mdp.css');	
		    echo $this->Html->css('prettify.css');	
			echo $this->Html->css('pepper-ginder-custom.css');	
		    echo $this->Html->script('prettify.js');	
			echo $this->Html->script('lang-css.js');	
		?>
		...
		<div id="page">
			...
			<div id="share">
				...
				<div id="tweet" style="padding-top: .5em;">
					...
					<script type="text/javascript">
						//$j('#tweet a').attr('data-text','MultiDatesPicker v' + latestMDPver);
					</script>
			...
			<div id="how-to">
				...
				<p>
					...
					<br>
					<code class="prettyprint">$j(element_or_selector).multiDatesPicker(options_to_initialize_datepicker_and_multidatepicker);</code>
				</p>
				...
				<ul>
					...
					<li id="method-gotDate">
						...
						<p>Example: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('gotDate', new Date());</code></p>
					</li>
					<li id="method-addDates">
						...
						<p>Example adding today: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('addDates', new Date());</code></p>
					</li>
					<li id="method-removeIndexes">
						...
						<p>Example removing first date: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('removeIndexes', 0);</code></p>
					</li>
					<li id="method-removeDates">
						...
						<p>Example removing today date: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('removeDates', new Date());</code></p>
					</li>
					<li id="method-resetDates">
						...
						<p>Example resetting disabled dates: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('resetDates', 'disabled');</code></p>
					</li>
					<li id="method-toggleDate">
						...
						<p>Example toggling today: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('toggleDate', new Date());</code></p>
					</li>
					<li id="method-getDates">
						...
						<p>Example: <code class="prettyprint">var dates = $j('#simpliest-usage').multiDatesPicker('getDates');</code></p>
					</li>
					<li id="method-value">
						...
						<p>Get Example: <code class="prettyprint">var dates = $j('#simpliest-usage').multiDatesPicker('value');</code></p>
						<p>Set Example: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('value', '2/19/1985, 11/14/2009');</code></p>
					</li>
					<li id="method-destroy">
						...
						<p>Example: <code class="prettyprint">$j('#simpliest-usage').multiDatesPicker('destroy');</code></p>
					</li>
				</ul>
			</div>
...
$j('#simpliest-usage').multiDatesPicker();
					...
					<li class="demo">
						...
						<div class="code-box">
							<h4>Code used</h4>
							<pre class="code prettyprint">
$j('#custom-date-format').multiDatesPicker({
	dateFormat: "y-m-d", 
	defaultDate:"85-2-19"
});</pre>
						</div>
					...
					<li class="demo">
						...
						<div class="code-box">
							...
							<pre class="code prettyprint">
var date = new Date();
$j('#pre-select-dates').multiDatesPicker({
	addDates: [date.setDate(14), date.setDate(19)]
					...
					<li class="demo">
						...
						<div class="code-box">
							...
							<pre class="code prettyprint">
var today = new Date();
$j('#disable-dates').multiDatesPicker({
...
$j('#disable-calendar').multiDatesPicker({
	disabled: true,
	addDates: [today, tomorrow]
					...
					<li class="demo">
						...
						<div class="code-box">
							<h4>Code used</h4>
							<pre class="code prettyprint">
$j('#custom-methods').multiDatesPicker({
	beforeShowDay: $.datepicker.noWeekends
					...
					<li class="demo">
						...
						<div class="code-box">
							<h4>Code used</h4>
							<pre class="code prettyprint">
$j('#with-altField').multiDatesPicker({
	altField: '#altField'
});</pre>
						</div>
					</li>
	...
	maxPicks: 2
					...
					<li class="demo">
						...
						<div class="code-box">
							...
							<pre class="code prettyprint">
var date = new Date();
$j('#pickableRange').multiDatesPicker({
	pickableRange: 7,
	...
	addDisabledDates: [date.setDate(10), date.setDate(15)]
					...
					<li class="demo">
						...
						<div class="code-box">
							<h4>Code used</h4>
							<pre class="code prettyprint">
$j('#simple-select-days-range').multiDatesPicker({
	mode: 'daysRange',
	autoselectRange: [0,5]
});</pre>
						</div>
					...
					<li class="demo">
						...
						<div class="code-box">
							...
							<pre class="code prettyprint">
var today = new Date();
$j('#simple-select-min-max').multiDatesPicker({
	minDate: 0,
	maxDate: 30
});</pre>
						</div>
